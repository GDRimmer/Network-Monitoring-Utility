...
from app import db
from app.models import Scan, Host, Port, PacketCapture
from app.forms import ScanForm, UploadForm, PacketCaptureForm
...
def index():
    ...
    form = ScanForm()
    return render_template('index.html', title='NMAP Scanner', form=form)
